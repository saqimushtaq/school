...
public class StudentDiscountService {
    ...
    public StudentDiscountResponse createStudentDiscount(StudentDiscountRequest request) {
        ...
        StudentDiscount studentDiscount = studentDiscountMapper.toEntity(request);
        ...
        StudentDiscount savedDiscount = studentDiscountRepository.save(studentDiscount);
    ...
    public StudentDiscountResponse getStudentDiscountById(Long id) {
        StudentDiscount studentDiscount = findStudentDiscountById(id);
    ...
    public StudentDiscountResponse updateStudentDiscount(Long id, StudentDiscountUpdateRequest request) {
        ...
        StudentDiscount updatedDiscount = studentDiscountRepository.save(studentDiscount);
        ...
        return studentDiscountMapper.toResponse(updatedDiscount);
    }
