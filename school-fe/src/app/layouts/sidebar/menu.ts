...
export const MENU: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      {
        id: 12,
        label: 'MENUITEMS.ACADEMIC.LIST.SUBJECTS',
        parentId: 8,
      ...
      {
        id: 23,
        label: 'MENUITEMS.ACADEMIC.LIST.CLASSSUBJECTS',
        parentId: 8,
        isCollapsed: true,
        link: '/academic/class-subjects',
      },
      {
        id: 27,
         label: 'MENUITEMS.ACADEMIC.LIST.GRADEBOUNDARY',
        parentId: 8,
        isCollapsed: true,
        link: '/academic/grade-boundary',
